        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu slideInLeft animated" aria-labelledby="navbarDropdown">
                <li><a class="dropdown-item" href="about.php#about_rammml2022">About RAMMML-2023</a></li>
                <li><a class="dropdown-item" href="aboutycce.php">About YCCE</a></li>
            </ul>
          </li>
...
<!-- rammml2022.php -->
          ...
          <li class="nav-item dropdown">
            <a class="nav-link <?php if($page=='links'){echo 'active';}?> dropdown-toggle" href="committees.php" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
              Important&nbsp;Links/Dates
            </a>
            <ul class="dropdown-menu slideInLeft animated" aria-labelledby="navbarDropdown">
              <li><a class="dropdown-item" href="downloads.php">Important&nbsp;Links</a></li>
              <li><a class="dropdown-item" href="dates.php">Important&nbsp;Dates</a></li>
